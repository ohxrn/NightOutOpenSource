        ...
        <nav class="gradient dark:gradient">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/home" class="flex items-center">
                    <img src={night2} class="h-11 mr-3 bg-gray" alt="Night Out Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap sm-hidden dark:text-blue text-blue">Night Out</span>
                </a>
                <div class="flex items-center md:order-2">
                    ...
                    {/* <!-- Dropdown menu --> */}
                    <div class="z-50 hidden my-4 text-base list-none reverse-gradient divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                        <div class="px-4 py-3">
                            <span class="block text-sm text-indigo dark:text-indigo">Night Walker 1</span>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 " id="navbar-user">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-white bg-indigo-600 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                        </li>
                        <li>
